...
export const toolName = 'displayGeoMap' as const
...
export type DisplayGeoMapInput = z.infer<typeof inputSchema>
export type DisplayGeoMapOutput = z.infer<typeof outputSchema>
