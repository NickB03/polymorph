...
- Runs 9 evaluators: 3 deterministic (`prechecks`, `tool-usage`, `no-tool-placeholders`) + 6 LLM-judge (`tool-selection`, `faithfulness`, `relevance`, `response-quality`, `safety`, `citation-accuracy`) via Phoenix experiment evaluator shells
