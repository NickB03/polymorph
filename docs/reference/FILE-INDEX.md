...
Curated index of the main files in the Polymorph repository, organized by directory. Each entry includes the file path and a one-line description; generated assets, historical plans, and low-level test fixtures may be summarized rather than listed exhaustively.
...
| File                                                       | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| ---------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `components/evals/dashboard-v2/dashboard.tsx`              | Top-level orchestrator: handles the empty-state branch, owns the `TooltipProvider` wrap and CSS-driven enter animations, routes Suites/History via `?view=`, drills into a chosen suite via `?suite=`, defaults to the latest attention suite when a threshold alert exists, and composes `SuiteSelector`, `EvaluatorBreakdown`, `CollapsibleComparison`, plus legacy primitives `ActivityList`/`ScoreFeature` from `components/evals/dashboard/` |
...
| `lib/utils/registry.ts`               | AI provider registry wrapping OpenRouter, Vercel AI Gateway, OpenAI, Anthropic, Google, Ollama, and compatible providers |
...
| `docs/getting-started/ENVIRONMENT.md`                      | Environment variable reference hub                                                                                                                |
| `docs/getting-started/ENVIRONMENT-CORE.md`                 | Required bootstrap variables, core controls, cloud controls, Supabase auth, and storage variables                                                 |
| `docs/getting-started/ENVIRONMENT-PROVIDERS.md`            | Search, AI, voice, canvas, optional feature, and map tile environment variables                                                                   |
| `docs/getting-started/ENVIRONMENT-OPERATIONS.md`           | Admin, cron, evals, Phoenix tracing, and research-fetch troubleshooting environment variables                                                     |
| `docs/getting-started/ENVIRONMENT-LOCAL.md`                | Local environment setup workflow plus guest chat and cloud-mode implementation notes                                                              |
| `docs/getting-started/CONFIGURATION.md`                    | Configuration guide for models, search providers, and feature flags                                                                               |
| `docs/architecture/OVERVIEW.md`                            | Architecture overview hub                                                                                                                         |
| `docs/architecture/OVERVIEW-TECH-STACK.md`                 | Framework, runtime, data, AI, search, tracing, and UI technology stack                                                                            |
| `docs/architecture/OVERVIEW-SYSTEM.md`                     | Top-level app surfaces, route groups, provider integrations, and key source files                                                                 |
| `docs/architecture/OVERVIEW-AGENT-PIPELINE.md`             | Chat request pipeline from auth and model selection through agent dispatch and SSE                                                                |
| `docs/architecture/OVERVIEW-TOOL-SYSTEM.md`                | Core tools, spatial helpers, display tools, and tool availability by agent                                                                        |
| `docs/architecture/OVERVIEW-STREAMING.md`                  | High-level streaming architecture, parallel post-processing, and authenticated vs guest stream paths                                              |
| `docs/architecture/OVERVIEW-DATABASE.md`                   | Active Drizzle/Supabase schema, indexes, and canonical message persistence                                                                        |
| `docs/architecture/OVERVIEW-AUTHENTICATION.md`             | Supabase auth flow, client patterns, middleware behavior, and guest mode                                                                          |
| `docs/architecture/OVERVIEW-GENERATIVE-UI.md`              | Chat message section rendering, display tools, dynamic tools, and collapse behavior                                                               |
| `docs/architecture/OVERVIEW-MODELS-STATE.md`               | Model selection and AI SDK tool state lifecycle                                                                                                   |
| `docs/architecture/OVERVIEW-RLS.md`                        | Row-Level Security policy chain and user context requirements                                                                                     |
| `docs/architecture/OVERVIEW-FILES.md`                      | Architecture overview source file map                                                                                                             |
...
| `docs/architecture/RESEARCH-AGENT.md`                      | Research agent reference hub                                                                                                                      |
| `docs/architecture/RESEARCH-AGENT-PIPELINE.md`             | Research agent overview and end-to-end request pipeline                                                                                           |
| `docs/architecture/RESEARCH-AGENT-TOOL-LOOP.md`            | ToolLoopAgent pattern, configuration, and invocation path                                                                                         |
| `docs/architecture/RESEARCH-AGENT-MODES.md`                | Chat and research mode behavior, active tools, prompts, and comparison table                                                                      |
| `docs/architecture/RESEARCH-AGENT-CORE-TOOLS.md`           | Core research agent tools: search, fetch, todo, competitor research, and spatial helpers                                                          |
| `docs/architecture/RESEARCH-AGENT-DISPLAY-TOOLS.md`        | Manifest-managed display tools and interactive Tool UI continuation behavior                                                                      |
| `docs/architecture/RESEARCH-AGENT-CONDITIONAL-TOOLS.md`    | Context-registered tools, message persistence contract, and dynamic tool parts                                                                    |
| `docs/architecture/RESEARCH-AGENT-SEARCH-PROVIDERS.md`     | Research agent search provider delegation and provider details                                                                                    |
| `docs/architecture/RESEARCH-AGENT-MODELS-CONTEXT.md`       | Research agent model selection and context-window management                                                                                      |
| `docs/architecture/RESEARCH-AGENT-STREAMING-AUXILIARY.md`  | Agent streaming integration plus title and related-questions auxiliary agents                                                                     |
| `docs/architecture/RESEARCH-AGENT-EXTENSION.md`            | Extension guide for new core tools, display tools, prompts, search providers, and AI providers                                                    |
| `docs/architecture/RESEARCH-AGENT-FILES.md`                | Research agent source file map                                                                                                                    |
| `docs/architecture/GENERATIVE-UI.md`                       | Generative UI reference hub                                                                                                                       |
| `docs/architecture/GENERATIVE-UI-OVERVIEW.md`              | Generative UI concepts and end-to-end rendering lifecycle                                                                                         |
| `docs/architecture/GENERATIVE-UI-DISPLAY-TOOLS.md`         | Server-side display tools, passthrough execution, tool definitions, and schema examples                                                           |
| `docs/architecture/GENERATIVE-UI-DISPLAY-CONTRACTS.md`     | Mode-specific display tool availability, geo-map contract, side-effect tools, and shared actions                                                  |
| `docs/architecture/GENERATIVE-UI-PORTABILITY-ACTIONS.md`   | Community-portability proof, shared base fields, and action system                                                                                |
| `docs/architecture/GENERATIVE-UI-REGISTRY-ADAPTERS.md`     | Tool UI registry, local adapter pattern, and schema validation layer                                                                              |
| `docs/architecture/GENERATIVE-UI-MESSAGE-RENDERING.md`     | RenderMessage buffer-and-flush strategy and display tool rendering path                                                                           |
| `docs/architecture/GENERATIVE-UI-COMPONENTS.md`            | Concrete display tool component behavior                                                                                                          |
| `docs/architecture/GENERATIVE-UI-INTERACTIVE-DYNAMIC.md`   | OptionList interactions, dynamic tool display, inspector panel, and research process grouping                                                     |
| `docs/architecture/GENERATIVE-UI-ADDING-TOOLS.md`          | Manifest-managed display tool addition checklist                                                                                                  |
| `docs/architecture/GENERATIVE-UI-FILES.md`                 | Generative UI server, runtime, component, rendering, canvas, and type file map                                                                    |
| `docs/architecture/STREAMING.md`                           | Streaming architecture reference hub                                                                                                              |
| `docs/architecture/STREAMING-STREAM-TYPES.md`              | Streaming overview and authenticated vs ephemeral stream comparison                                                                               |
| `docs/architecture/STREAMING-REQUEST-DISPATCH.md`          | Streaming request parsing, auth, model selection, dispatch, and stream creation                                                                   |
| `docs/architecture/STREAMING-AGENT-FINALIZATION.md`        | Streaming message preparation, agent execution, related questions, persistence, and response return                                               |
| `docs/architecture/STREAMING-SEQUENCE-DIAGRAM.md`          | Full streaming sequence diagram                                                                                                                   |
| `docs/architecture/STREAMING-MESSAGE-PREPARATION.md`       | Submit, regenerate, interactive tool output, pruning, and truncation message preparation                                                          |
| `docs/architecture/STREAMING-OPERATIONS.md`                | Smooth streaming, parallel operations, and error handling                                                                                         |
| `docs/architecture/STREAMING-SSE-PROTOCOL.md`              | SSE headers, event shapes, client consumption, portable tool boundary, and key files                                                              |
| `docs/architecture/MODEL-CONFIGURATION.md`                 | Model configuration reference hub                                                                                                                 |
| `docs/architecture/MODEL-CONFIGURATION-STRUCTURE.md`       | Model config schema, config object structure, and profile loading                                                                                 |
| `docs/architecture/MODEL-SELECTION.md`                     | Model selection algorithm, default model assignments, and fallback behavior                                                                       |
| `docs/architecture/AI-PROVIDER-REGISTRY.md`                | AI provider registry plus model and provider edit path                                                                                            |
| `docs/architecture/SEARCH-PROVIDERS.md`                    | Search provider reference hub                                                                                                                     |
| `docs/architecture/SEARCH-PROVIDER-SELECTION.md`           | Search provider comparison, routing logic, and retry/error behavior                                                                               |
| `docs/architecture/SEARCH-PROVIDER-SETUP.md`               | Tavily, Brave, Exa, SearXNG, and Firecrawl setup details                                                                                          |
| `docs/architecture/SEARCH-TOOL-SCHEMA.md`                  | Chat vs research search behavior, tool schema, search types, and provider extension path                                                          |
| `docs/architecture/DECISIONS.md`                           | Architectural decision records (ADRs)                                                                                                             |
| `docs/reference/API.md`                                    | API reference hub                                                                                                                                 |
| `docs/reference/API-CHAT.md`                               | Request flow, authentication modes, and streaming chat endpoint                                                                                   |
| `docs/reference/API-CORE-ENDPOINTS.md`                     | Core API endpoint family hub                                                                                                                      |
| `docs/reference/API-RESOURCE-ENDPOINTS.md`                 | Chat listing, file upload, and feedback endpoints                                                                                                 |
| `docs/reference/API-AUXILIARY-ENDPOINTS.md`                | Advanced search, suggestions, voice synthesis, and health check endpoints                                                                         |
| `docs/reference/API-CANVAS-ENDPOINTS.md`                   | Canvas artifact lifecycle endpoints                                                                                                               |
| `docs/reference/API-CANVAS-ASSETS.md`                      | Canvas asset helper endpoint for image proxying                                                                                                   |
| `docs/reference/API-EVALS-LIMITS.md`                       | Eval replay endpoint, cloud rate limits, and error response conventions                                                                           |
| `docs/reference/FILE-INDEX.md`                             | This file; every file in the repository with a one-line description                                                                               |
| `docs/operations/DEPLOYMENT.md`                            | Deployment operations hub                                                                                                                         |
| `docs/operations/DEPLOYMENT-PRODUCTION.md`                 | Production deployment baseline, Vercel cron, healthchecks, rollback, and staging checklist                                                        |
| `docs/operations/PHOENIX-OPERATIONS.md`                    | Phoenix observability service, persistence verification, tracing setup, and API key rotation                                                      |
| `docs/operations/EVALS-CRON.md`                            | Railway `polymorph-evals` cron service, defaults, required environment, and manual-run caveat                                                     |
| `docs/operations/DOCKER.md`                                | Docker-specific setup and configuration instructions                                                                                              |
| `docs/operations/TROUBLESHOOTING.md`                       | Troubleshooting hub                                                                                                                               |
| `docs/operations/TROUBLESHOOTING-SETUP.md`                 | Environment, port, SSL, and provider-enable setup troubleshooting                                                                                 |
| `docs/operations/TROUBLESHOOTING-RUNTIME.md`               | Auth, share-page, Supabase timeout, and rate-limit runtime troubleshooting                                                                        |
| `docs/operations/TROUBLESHOOTING-BUILD-SEARCH-DATABASE.md` | Build, search, database, and escalation troubleshooting                                                                                           |
...
| `services/evals/src/evaluators/tool-selection.ts`       | Tool selection evaluator — LLM judge labeling whether the agent picked the right tool(s) for the query (`correct`/`wrong`/`missing`/`not_required`)                                       |
| `services/evals/src/evaluators/no-tool-placeholders.ts` | No-tool-placeholders evaluator — deterministic check that raw answer text contains no unrendered display-tool placeholder patterns                                                        |
