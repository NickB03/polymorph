      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              'group/sidebar-wrapper flex h-app-viewport w-full has-data-[variant=inset]:bg-sidebar',
  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            'fixed inset-y-0 z-10 hidden h-app-viewport w-(--sidebar-width) transition-[left,right,width] duration-200 ease-linear md:flex',
            side === 'left'
